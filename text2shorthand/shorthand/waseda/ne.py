...
class CharNe(WasedaChar):
    ...
    def path_ELCLel(cls, ta=None, **kwargs):
        #M 142.194,117.418 C 150.36,119.006 187.21,125.201 187.21,117.418 187.21,116.40867 186.47071,116.06766 185.8178,116.03716 184.1807,115.96068 183.60402,116.54037 183.8033,117.24938 183.98448,117.89393 184.59877,118.49789 186.02,119.466

        #z0 = P(0, -0)
        #c0 = P(2.87002, -0.558118)
        #c1 = P(15.8213, -2.73541)
        #z1 = P(15.8213, -0)
        #c2 = P(15.8213, 0.354739)
        #c3 = P(15.5615, 0.47459)
        #z2 = P(15.332, 0.48531)
        #c4 = P(14.7566, 0.51219)
        #c5 = P(14.554, 0.308452)
        #z3 = P(14.624, 0.0592632)
        #c6 = P(14.6877, -0.16727)
        #c7 = P(14.9036, -0.379538)
        ...
        #c1 = z1 + P(0, -2.73541)
        #c2 = z1 + P(0, 0.354739)
        #z2 = z1 + P(-0.489302, 0.48531)
        #c3 = z2 + P(0.229472, -0.0107195)
        #c4 = z2 + P(-0.575375, 0.0268797)
        #z3 = z2 + P(-0.708016, -0.426047)
        #c5 = z3 + P(-0.0700389, 0.249189)
        #c6 = z3 + P(0.0636775, -0.226533)
        #z4 = z3 + P(0.779081, -0.779053)
        #c7 = z4 + P(-0.499505, 0.340252)
        ...
        c1 = z1 + PP(2.73541, -90)
        c2 = z1 + PP(0.354739, 90)
        z2 = z1 + PP(0.689161, 135)
        c3 = z2 + PP(0.229722, -2)
        c4 = z2 + PP(0.576002, 177)
        #z3 = z2 + PP(0.826319, -148)
        z3 = z4 - PP(1.10177, ta + -9)
        c5 = z3 + PP(0.258844, 105)
        #c6 = z3 + PP(0.235313, -74)
        #z4 = z3 + PP(1.10177, -44)
        #c7 = z4 + PP(0.604381, 145)
