...
class CharNi(WasedaChar):
    ...
    def path_ELCLel(cls, ta=None, **kwargs):
        #M 120.148,117.099 C 126.351,118.995 142.74,122.541 142.74,117.099 142.74,115.713 141.78792,114.91762 140.914,114.675 140.04085,114.4326 138.89539,115.21573 139.30785,116.17072 139.82551,117.36928 140.97453,118.07431 142.14057,118.58406

        #z0 = P(0, -0)
        #c0 = P(2.18011, -0.666368)
        ...
        #c5 = P(6.58896, 0.661894)
        #z3 = P(6.73392, 0.326253)
        #c6 = P(6.91586, -0.0949926)
        #c7 = P(7.31969, -0.342782)
        z4 = P(7.72951, -0.521939)

        #z0 = P(0, -0)
        #c0 = z0 + P(2.18011, -0.666368)
        #z1 = z0 + P(7.94018, 0)
        #c1 = z1 + P(0, -1.91264)
        #c2 = z1 + P(0, 0.487123)
        ...
        #z3 = z2 + P(-0.564497, -0.525686)
        #c5 = z3 + P(-0.144963, 0.335641)
        #c6 = z3 + P(0.181937, -0.421246)
        #z4 = z3 + P(0.995587, -0.848192)
        #c7 = z4 + P(-0.409816, 0.179157)
        ...
        #z3 = z2 + PP(0.771364, -137)
        z3 = z4 - PP(1.30791, ta + -16)
        c5 = z3 + PP(0.365608, 113)
        #c6 = z3 + PP(0.458856, -66)
        #z4 = z3 + PP(1.30791, -40)
        #c7 = z4 + PP(0.447266, 156)
