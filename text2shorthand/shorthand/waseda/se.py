...
class CharSe(WasedaChar):
    ...
    def path_NELCLnel(cls, ta=None, **kwargs):
        #M 2937.54,0 C 2946.1,-4.94249 2970.35,-18.3947 2970.35,-27.5268 2970.35,-29.005 2969.1795,-28.922651 2968.4109,-28.815446 2967.1514,-28.639782 2965.8676,-26.80512 2965.9326,-25.91507 2966.0426,-24.29727 2968.3348,-25.667825 2970.1848,-26.694625

        #z0 = P(0, 0)
        #c0 = P(3.01978, 1.7436)
        #c1 = P(11.5746, 6.48924)
        #z1 = P(11.5746, 9.71084)
        #c2 = P(11.5746, 10.2323)
        #c3 = P(11.1617, 10.2033)
        #z2 = P(10.8906, 10.1654)
        #c4 = P(10.4462, 10.1035)
        #c5 = P(9.99335, 9.45625)
        #z3 = P(10.0163, 9.14226)
        #c6 = P(10.0551, 8.57154)
        #c7 = P(10.8637, 9.05504)
        z4 = P(11.5164, 9.41727)

        #z0 = P(0, 0)
        #c0 = z0 + P(3.01978, 1.7436)
        #z1 = z0 + P(11.5746, 9.71084)
        #c1 = z1 + P(0, -3.2216)
        #c2 = z1 + P(0, 0.521476)
        #z2 = z1 + P(-0.684071, 0.454606)
        #c3 = z2 + P(0.271145, 0.0378195)
        #c4 = z2 + P(-0.444324, -0.0619704)
        #z3 = z2 + P(-0.874289, -1.02319)
        #c5 = z3 + P(-0.0229306, 0.31399)
        #c6 = z3 + P(0.0388056, -0.570724)
        #z4 = z3 + P(1.50008, 0.27501)
        #c7 = z4 + P(-0.652639, -0.362232)
        ...
        z2 = z1 + PP(0.821353, 146)
        c3 = z2 + PP(0.27377, 7)
        c4 = z2 + PP(0.448624, -172)
        #z3 = z2 + PP(1.34584, -130)
        z3 = z4 - PP(1.52508, ta + 340)
        c5 = z3 + PP(0.314826, 94)
        #c6 = z3 + PP(0.572042, -86)
        #z4 = z3 + PP(1.52508, 10)
        #c7 = z4 + PP(0.746425, -150)
