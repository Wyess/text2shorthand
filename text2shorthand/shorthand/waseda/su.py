...
class CharSu(WasedaChar):
    ...
    def path_NELCLnel(cls, ta=None, **kwargs):
        #M 100.629,152.193 C 106.38,149.006 117.07,144.897 117.07,138.397 117.07,135.417 107.11711,141.96085 108.15483,145.64818 108.47125,146.77249 110.20229,146.41987 111.62729,146.11687
        #
        #z0 = P(0, -0)
        #c0 = P(2.02125, 1.1201)
        #c1 = P(5.77835, 2.56425)
        #z1 = P(5.77835, 4.84874)
        #c2 = P(5.77835, 5.89609)
        #c3 = P(2.28031, 3.59619)
        #z2 = P(2.64503, 2.30024)
        #c4 = P(2.75624, 1.90509)
        #c5 = P(3.36463, 2.02902)
        z3 = P(3.86546, 2.13552)
        ...
        #c1 = z1 + P(0, -2.28449)
        #c2 = z1 + P(0, 1.04735)
        #z2 = z1 + P(-3.13332, -2.5485)
        #c3 = z2 + P(-0.364717, 1.29595)
        #c4 = z2 + P(0.111209, -0.39515)
        #z3 = z2 + P(1.22043, -0.164726)
        #c5 = z3 + P(-0.50083, -0.106492)
        ...
        c1 = z1 + PP(2.28449, -90)
        c2 = z1 + PP(1.04735, 90)
        #z2 = z1 + PP(4.03888, -140)
        #z2 = z3 - PP(1.2315, ta+6)
        z2 = z3 - PP(1.2315, ta-20)
        c3 = z2 + PP(1.34629, 105)
        #c4 = z2 + PP(0.410501, -74)
        #z3 = z2 + PP(1.2315, -7)
        #c5 = z3 + PP(0.512027, -167)
