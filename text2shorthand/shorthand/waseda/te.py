...
class CharTe(WasedaChar):
    ...
    def path_NECLsw(cls, ta=None, **kwargs):
        #M 281.822,66.8497 C 290.692,55.8965 300.41418,45.721558 310.604,35.9845 311.7496,34.889801 312.6732,34.439824 312.18793,33.626885 311.84262,33.048416 310.72175,32.965726 310.17637,33.822813 309.631,34.679901 308.384,37.52605 307.928,38.5037

        #z0 = P(0, -0)
        #c0 = P(3.12914, 3.86405)
        #c1 = P(6.55891, 7.45354)
        #z1 = P(10.1536, 10.8886)
        #c2 = P(10.5578, 11.2747)
        #c3 = P(10.8836, 11.4335)
        #z2 = P(10.7124, 11.7203)
        #c4 = P(10.5906, 11.9243)
        #c5 = P(10.1952, 11.9535)
        #z3 = P(10.0028, 11.6512)
        #c6 = P(9.8104, 11.3488)
        #c7 = P(9.37048, 10.3447)
        z4 = P(9.20962, 9.99984)

        #z0 = P(0, -0)
        #c0 = z0 + P(3.12914, 3.86405)
        #z1 = z0 + P(10.1536, 10.8886)
        #c1 = z1 + P(-3.59474, -3.43502)
        #c2 = z1 + P(0.404142, 0.386185)
        #z2 = z1 + P(0.558775, 0.831714)
        #c3 = z2 + P(0.171192, -0.286787)
        #c4 = z2 + P(-0.121818, 0.204071)
        #z3 = z2 + P(-0.709634, -0.069119)
        #c5 = z3 + P(0.192398, 0.302361)
        #c6 = z3 + P(-0.192394, -0.302362)
        #z4 = z3 + P(-0.793175, -1.65131)
        #c7 = z4 + P(0.160867, 0.344893)

        z0 = P(0, -0)
        c0 = z0 + PP(4.97216, 50)
        z1 = z0 + PP(14.8882, 47)
        c1 = z1 + PP(4.97207, -136)
        c2 = z1 + PP(0.55899, 43)
        z2 = z1 + PP(1.00199, 56)
        c3 = z2 + PP(0.333996, -59)
        c4 = z2 + PP(0.237665, 120)
        #z3 = z2 + PP(0.712992, -174)
        z3 = z4 - PP(1.83193, ta + 1)
        c5 = z3 + PP(0.358384, 57)
        #c6 = z3 + PP(0.358383, -122)
        #z4 = z3 + PP(1.83193, -115)
        #c7 = z4 + PP(0.380565, 64)
